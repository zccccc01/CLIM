...
func newFriend(db *gorm.DB, opts ...gen.DOOption) friend {
	...
	_friend.UserID = field.NewBytes(tableName, "user_id")
	_friend.FriendID = field.NewBytes(tableName, "friend_id")
	_friend.Remark = field.NewString(tableName, "remark")
	_friend.Deleted = field.NewInt32(tableName, "deleted")
...
type friend struct {
	...
	ALL       field.Asterisk
	UserID    field.Bytes  // User UUID
	FriendID  field.Bytes  // Friend UUID, the user who is a friend of the user
	Remark    field.String // A remark or note about the friendship (optional)
	Deleted   field.Int32  // Indicates whether the friendship is deleted (0: active, 1: deleted)
	CreatedAt field.Time   // Friendship creation time
